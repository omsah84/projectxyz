...
const AboutSection = () => {
  return (
    <section className={useStyles.section}>
      ...
      <Typography variant="h6" component="h3" className={useStyles.subheading}>
        Our Story & Mission
      </Typography>
      <Typography variant="body1" className={useStyles.text}>
      ...
      <Button href="/contact" className={useStyles.button}>
        Contact Us
      </Button>
    </section>
  );
